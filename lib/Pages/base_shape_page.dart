...
class _BaseShapePageState extends State<BaseShapePage>
  ...
  void initState() {
    ...
    for (var param in widget.parameters) {
      ...
      _focusNodes[param] = FocusNode();

      // Manage focus and auto-assignment changes natively
      _focusNodes[param]!.addListener(() {
        if (_focusNodes[param]!.hasFocus) {
          setState(() {
  ...
  Widget _buildParameterCard(BuildContext context, String parameter) {
    ...
    const double maxSwipeDistance = 60.0;
                              ...
                              children: [
                                Expanded(
                                  child: CupertinoTextField(
                                    ...
                                    focusNode: _focusNodes[parameter],
